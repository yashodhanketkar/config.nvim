return {
	...
	{ "christoomey/vim-tmux-navigator", event = "VeryLazy" },
	{
      ...
      map("<leader>h1", function() harpoon:list():select(1) end, "Open item 1 from harpoon list")
      map("<leader>h2", function() harpoon:list():select(2) end, "Open item 2 from harpoon list")
      map("<leader>h3", function() harpoon:list():select(3) end, "Open item 3 from harpoon list")
      map("<leader>h4", function() harpoon:list():select(4) end, "Open item 4 from harpoon list")
			-- stylua: ignore end
		end,
	},
	{
